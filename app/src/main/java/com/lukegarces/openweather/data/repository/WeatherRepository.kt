...
class WeatherRepository(private val apiService: ApiService, private val locationHelper: LocationHelper) {
    ...
    suspend fun getWeatherByCurrentLocation(): ApiResult<WeatherResponse> {
        return try {
            val location = locationHelper.getCurrentLocationInfo()
            ...
            ApiResult.Error("Location permission not granted")
